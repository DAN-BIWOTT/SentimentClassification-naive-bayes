...
public class SentimentalAnalysis {
	public static final String TRAINING_DATA_SET_FILENAME = "training.csv";
	public static final String TESTING_DATA_SET_FILENAME = "test.csv";
	public static final String PREDICTION_DATA_SET_FILENAME = "prediction.arff";
	
	public String getAnalysisResponse() {
		// TODO Auto-generated method stub
		return "{\"text\":\"text\"}";
	}

	public Object createDataSet(SentimentalAnalysis data) {
		// TODO Auto-generated method stub
		
		try {
			String trainFile = System.getProperty("user.home")+"\\eclipse-workspace\\sentimentAnalysis\\src\\main\\java\\com\\example\\demo\\controller\\Train.data", testFile = System.getProperty("user.home")+"\\eclipse-workspace\\sentimentAnalysis\\src\\main\\java\\com\\example\\demo\\controller\\Test.data", vocabFile = System.getProperty("user.home")+"\\eclipse-workspace\\sentimentAnalysis\\src\\main\\java\\com\\example\\demo\\controller\\Vocab.data", stopwordFile = System.getProperty("user.home")+"\\eclipse-workspace\\sentimentAnalysis\\src\\main\\java\\com\\example\\demo\\controller\\stopwords.txt";
